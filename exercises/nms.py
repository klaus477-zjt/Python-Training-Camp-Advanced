...
def calculate_iou(box1, box2):
    ...
    box1_area = (box1[2]-box1[2])*(box1[2]-box1[2])
    box2_area = (box2[2]-box2[2])*(box2[2]-box2[2])
...
def nms(boxes, scores, iou_threshold):
    ...
    while orders.size>0:
        ...
        union_areas = areas[i]+areas[orders[1:]]-inter_areas
        
        ious = inter_areas/np.maximum(union_areas, 1e-6)
